  ...
  factory: (require) => {
    ...
    var pluginCss = '\n'
      ...
      + '.am-danger-btn:disabled{opacity:.4;cursor:default}\n'
       + '.am-archive-btn{display:none}\n'
       + '.am-header .am-menu{display:none}\n'
      ...
      + '.am-filter-selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}\n'
       + '.am-filter-selector:hover{background:var(--dsw-alias-interactive-bg-hover)}\n'
       + '.am-filter-selector:focus-visible{outline:none;box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}\n'
      ...
      + '.am-delete-btn,.am-archive-confirm-btn{height:36px;padding:0 16px;border-radius:18px;border:none;background:var(--dsw-alias-state-error-primary);color:#fff;cursor:pointer;font-size:13px;font-family:inherit}\n'
      + '.am-delete-btn:hover:not(:disabled),.am-archive-confirm-btn:hover:not(:disabled){filter:brightness(.92)}\n'
      + '.am-cancel-btn:disabled,.am-delete-btn:disabled,.am-archive-confirm-btn:disabled{opacity:.4;cursor:default}\n'
    ...
    function ArchivedSection(props) {
      ...
      return createElement(
        ...
        createElement('div', { className: 'am-header' },
          createElement('h1', { className: 'am-heading' }, tr('title')),
           createElement(GroupMenu, {
             labelKey: 'archiveUngroupedMenu',
             onDelete: archiveUngrouped,
             disabled: busy || ungroupedIds.length === 0,
           }),
          createElement('button', {
            type: 'button',
            className: 'am-archive-btn',
             'aria-hidden': true,
             onClick: archiveUngrouped,
             disabled: busy || ungroupedIds.length === 0,
           }, tr('archiveUngrouped', { count: ungroupedIds.length })),
           createElement('button', {
             type: 'button',
        ...
        pendingConfirm ? createElement(
          'div',
          { className: 'am-mask', role: 'dialog', 'aria-modal': 'true', 'aria-label': tr(pendingConfirm.kind === 'archive' ? 'confirmArchiveTitle' : 'confirmDeleteTitle') },
          createElement(
            'div',
            { className: 'am-modal' },
            createElement('h2', { className: 'am-modal-title' }, tr(pendingConfirm.kind === 'archive' ? 'confirmArchiveTitle' : 'confirmDeleteTitle')),
            createElement('p', { className: 'am-modal-body' }, tr(pendingConfirm.kind === 'archive' ? 'confirmArchiveBody' : 'confirmDeleteBody',
            ...
            createElement('div', { className: 'am-modal-actions' },
              ...
              createElement('button', {
                type: 'button',
                className: pendingConfirm.kind === 'archive' ? 'am-archive-confirm-btn' : 'am-delete-btn',
                onClick: confirmPending,
                disabled: busy,
              }, tr(pendingConfirm.kind === 'archive' ? 'archive' : 'delete')),
            ),
          ),
        ) : null,
      )
