                        ...
                        return createElement(
                          ...
                          createElement('div', { className: 'am-row-main' },
                            ...
                            createElement('div', { className: 'am-row-meta' },
                               ...
                               createElement('span', {
                                 className: 'am-row-id-value-legacy',
                                 'data-legacy-title': row.id,
                               }, displaySessionId(row.id)),
                               createElement('button', {
                                 type: 'button',
                                 className: 'am-copy-id am-hidden-legacy',
                                 'aria-label': tr('copyId'),
                                 title: tr('copyId'),
                                 onClick: function () { copySessionId(row.id) },
                               }, tr('copyId')),
                             ),
                             false ? createElement('div', { className: 'am-row-time' },
                              formatDate(row.updatedAt)) : null,
                          ),
                          createElement('button', {
                            type: 'button',
