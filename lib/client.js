...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var pluginCss = '\n'
      ...
      + '.am-danger-btn:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}\n'
      ...
      + '.am-search svg{flex:0 0 auto;color:var(--dsw-alias-label-tertiary)}\n'
      + '.am-search:focus-within{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px color-mix(in srgb,var(--dsw-alias-state-business-primary) 18%,transparent)}\n'
      ...
      + '.am-search-input::placeholder{color:var(--dsw-alias-label-dimmed)}\n'
      ...
      + '.am-controls-focus:focus-visible{outline:none;border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px color-mix(in srgb,var(--dsw-alias-state-business-primary) 18%,transparent)}\n'
      + '.am-error{margin:0;font-size:12px;color:var(--dsw-alias-state-error-primary);white-space:pre-wrap}\n'
      + '.am-empty{margin:0;font-size:13px;color:var(--dsw-alias-label-tertiary)}\n'
      ...
      + '.am-group-label{flex:1 1 auto;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:.06em;color:var(--dsw-alias-label-tertiary)}\n'
      + '.am-group-count{margin-left:auto;font-size:12px;color:var(--dsw-alias-label-tertiary)}\n'
      + '.am-group-list{display:flex;flex-direction:column;gap:8px}\n'
      + '.am-row{display:flex;align-items:center;gap:12px;padding:12px 14px;border-radius:10px;background:var(--dsw-alias-bg-layer-3);border:1px solid var(--dsw-alias-border-l2)}\n'
      ...
      + '.am-row-time{font-size:12px;color:var(--dsw-alias-label-tertiary);margin-top:3px}\n'
      ...
      + '.am-icon-btn:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-state-error-primary)}\n'
      + '.am-btn{height:28px;padding:0 10px;border-radius:14px;font-size:12px;border:none;cursor:pointer;font-family:inherit;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-primary)}\n'
      ...
      + '.am-btn:focus-visible,.am-icon-btn:focus-visible,.am-danger-btn:focus-visible{outline:none;box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}\n'
      + '.am-menu{position:relative}\n'
      + '.am-menu-backdrop{position:fixed;inset:0;z-index:900}\n'
      + '.am-menu-pop{position:absolute;top:calc(100% + 4px);right:0;z-index:901;min-width:250px;padding:4px;background:var(--dsw-alias-bg-layer-3);color:var(--dsw-alias-label-primary);border:1px solid var(--dsw-alias-border-l2);border-radius:8px;box-shadow:var(--dsw-shadow-lv1)}\n'
      ...
      + '.am-menu-item:hover{background:var(--dsw-alias-interactive-bg-hover)}\n'
      + '.am-mask{position:fixed;inset:0;z-index:1200;background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);display:flex;align-items:center;justify-content:center;padding:16px}\n'
      + '.am-modal{width:min(480px,100%);background:var(--dsw-alias-bg-layer-2);border-radius:16px;padding:22px;border:1px solid var(--dsw-alias-border-l2);box-shadow:var(--dsw-shadow-lv3)}\n'
      ...
      + '.am-cancel-btn:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}\n'
      ...
      return createElement(
        ...
        createElement('div', { className: 'am-tools' },
          ...
          createElement('select', {
            className: 'am-select am-controls-focus',
            value: sortBy,
